...
//note: font_scale, stroke_px, and stroke_spacing arte identical to 
//Vex.Flow.stavenote_render_codes
Vex.Flow.Accidental.prototype.setRenderOptions = function () {
	this.size = this.size.replace('_w', '');
	Vex.Merge(this.render_options, Vex.Flow.accidental_render_codes[this.size]);
	return this;
}
