...
Vex.Flow.ModifierContext.prototype.formatAccidentals = function() {
  ...
  //jensming move accidental_spacing up to public member status = adjust based on size
  //var accidental_spacing = 2;
  //var accidental_spacing = 6;
  ...
  for (var i = 0; i < acc_list.length; ++i) {
    ...
    acc_shift += acc.getWidth() + this.accidental_spacing; // spacing
