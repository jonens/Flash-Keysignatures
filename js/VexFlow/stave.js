...
Vex.Flow.Stave.prototype.addModifier = function(modifier) {
  ...
  console.log("glyph code: " + this.glyphs[this.glyphs.length - 1].code);
  return this;
}

Vex.Flow.Stave.prototype.addKeySignature = function(keySpec, clefType) {
	this.addModifier(new Vex.Flow.KeySignature(keySpec, clefType));
	return this;
}

Vex.Flow.Stave.prototype.addClef = function(clef) {
  this.addModifier(new Vex.Flow.Clef(clef).setPoint(Vex.Flow.clef_points[this.options.size]));
  return this;
}

Vex.Flow.Stave.prototype.addTimeSignature = function(timeSpec) {
  this.addModifier(new Vex.Flow.TimeSignature(timeSpec, this.options.size));
  return this;
}
 ...
 */
 //jensming add start_bar and end_bar parameters
Vex.Flow.Stave.prototype.draw = function(context, start_bar, end_bar) {
